...
public interface UsesPostgres {
  ...
  default Connection getPostgresConnection() {
    return POSTGRES_DB.getConnection();
  }
  ...
  default Map<String, String> getPostgresProperties() {
    ...
    properties.put(
        "datasources.default.driverClassName", POSTGRES_DB.getContainer().getDriverClassName());
